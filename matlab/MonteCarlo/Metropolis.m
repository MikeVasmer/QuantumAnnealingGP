function [ q ] = Metropolis( spins1, spins2, H, T, timesteps )
...
for time = 1:timesteps
    ...
    p_1 = transition_probability(spin_config_1, newspin1, H, T, Gamma);
    p_2 = transition_probability(spin_config_2, newspin2, H, T, Gamma);
