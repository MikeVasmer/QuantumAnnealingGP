function [out] = two_local()
   ...
   % Require: |J_N| < q_0 << J_a
    ...
    eigenvalues = ...
    eigenspectrum(  transverse_hamiltonian(6),...                   % Starting (transverse) Hamiltonian
    ...
    disp(strcat('Minimum gap (6 qubit system):', num2str(minimum_gap(eigenvalues))))

    disp('Eigenvalues of 6 qubit system')
