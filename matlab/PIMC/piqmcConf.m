function [ solution ] = piqmcConf(spin_start, HParams, monte_steps, trotter_slices, G_start, Temperature, step_flips)
...
%                 ediff = energyChange(new_spin_config, indices_to_flip, trotter_slices, J_orth, slice, h, Jzz, Jzzz);
                ediff = Ham_d1(new_spin_config, HParams, trotter_slices, Temperature, G) - Ham_d1(spin_config, HParams, trotter_slices, Temperature, G);
